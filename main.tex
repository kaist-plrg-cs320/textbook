...
\newcommand{\ebind}[3]{\textsf{val}\ #1=#2\ \textsf{in}\ #3}
\newcommand{\efun}[2]{\lambda#1.#2}

\newcommand{\eval}[3]{#1\vdash#2\Rightarrow#3}
\newcommand{\evaln}[3]{\ensuremath{#2} evaluates to \ensuremath{#3} under \ensuremath{#1}}
...
\input{chapters/lambda-calculus.tex}
...
\input{chapters/untyped-exercises.tex}
