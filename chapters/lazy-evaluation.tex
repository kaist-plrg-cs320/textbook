...
hand, the argument must not be evaluated in the CBN semantics. Instead of
...
The result of an expression with side effects vary in the order of
...
Purely function languages with lazy evaluation usually adopt call-by-need
...
\item Show the results of each expression in an CBV language and a CBN language.
