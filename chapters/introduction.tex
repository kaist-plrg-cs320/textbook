...
according to syntax. Syntax decides characters used in programs. Once programs
...
semantics fills the inside of them. A programming language with syntax and
...
puts things different from other languages in its standard library. Some
...
their semantics, while others provide them with their standard libraries.
...
developers consider standard libraries and ecosystems as well as syntax and
...
he should learn the computer again. On the other hand, if he knows that a
...
important to learn languages. To use a new language, becoming familiar with the
new syntax is all they need to use the language fluently.

This book explains the semantics of principal concepts in programming languages.
\refch{introduction-to-scala}, \refch{functional-programming},
\refch{functions}, \refch{scala-collections}, and \refch{pattern-matching}
...
\refch{syntax} and \refch{semantics} respectively explain syntax and
