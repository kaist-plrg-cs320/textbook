...
languages. For instance, defining the semantics of function application with
...
define substitutions. To find more about substitution, see Exercise 8 of
\refch{first-class-functions}.}
...
is a binding occurrence. The meaning of $\cx$
...
expressions. It helps the readers understand de Bruijn indices. At the same time, the
...
where metavariable $i$ ranges over indices.
...
Metavariable $\chi$ ranges over contexts.
