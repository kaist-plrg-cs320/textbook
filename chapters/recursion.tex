...
\item Consider the new semantics of \textsf{if0} as follows:
\[
  \begin{array}{c}
  \inferrule
...
\item Explain what is wrong with the following expression and describe how
  to fix it.
...
\item Mutually recursive functions are functions that call each
...
Fill every \code{???} to complete the expression.
