...
\textit{typing rules}\index{typing rules}.
...
languages \textit{untyped languages}\index{untyped languages} or
\textit{dynamically typed languages}\index{dynamically typed languages}.
...
\typerule{Typ-Fun}{
  If
  \typeofn{\Gamma[x\mapsto\tau_1]}{e}{\tau_2}, \\
  then
...
\[
  \inferrule
  { \typeof{\Gamma[x\mapsto\tau_1]}{e}{\tau_2} }
...
$\Gamma[x\mapsto\tau_1]$. If the type of $e$ is $\tau_2$, the return type of
...
\begin{array}{@{}r@{~}c@{~}l@{}}
  ...
  \Gamma_1&=&[\cx\mapsto\tnum] \\
  \Gamma_2&=&[\cx\mapsto\tnum,\cy\mapsto\tnum] \\
\end{array}
$
...
\typerule{Typ-Val}{
  If
    ...
    \typeofn{\Gamma[x\mapsto\tau_1]}{e_2}{\tau_2}, \\
  then
...
\[
  ...
  {
    \typeofd{e_1}{\tau_1} \\
    \typeof{\Gamma[x\mapsto\tau_1]}{e_2}{\tau_2}
  }
