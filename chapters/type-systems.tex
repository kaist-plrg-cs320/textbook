...
\code{null} is a value that belongs to any type.\footnote{In fact, Java
...
\typerule{Typ-Fun}{
  If
  \typeofn{\Gamma[x:\tau_1]}{e}{\tau_2},\footnote{
...
\[
  ...
  \end{array}
\]
The dynamic semantic of pointers is the same as \refex{mutable-variables-ptr}.
