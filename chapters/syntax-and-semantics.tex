...
\begin{kaobox}[frametitle=Partial functions]
  A partial function from a set $A$ to a set $B$ is a function from a subset of
  $A$ to $B$.
...
Sometimes, we call a proof tree proving the result of a program a \textit{derivation
tree}\index{derivation tree} since the tree explains how the result of the
program is derived.
