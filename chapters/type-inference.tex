...
\begin{array}{@{}r@{\hskip4pt}c@{\hskip4pt}l@{}}
  ...
  &&
  \inferrule
  { \mathit{FTV}(\tau)\setminus\mathit{FTV}(\Gamma)=\{\alpha_1,\ldots,\alpha_n\} }
  { \tau\prec_\Gamma\tforall{\alpha_1}{\cdots\tforall{\alpha_n}{\tau}} }
  \\[2em]
\mathit{FTV}(\tnum) &=& \emptyset
\\
\mathit{FTV}(\tbool) &=& \emptyset
\\
\mathit{FTV}(\tarrow{\tau_1}{\tau_2}) &=& \mathit{FTV}(\tau_1) \cup \mathit{FTV}(\tau_2)
\\
...
generalization of a type to a type scheme. $\mathit{FTV}$ denotes free type
