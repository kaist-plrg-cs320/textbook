...
As these example shows, constraints collected by the procedure are the same as
...
avoid using the map. As the first step, we changes the definition of \code{VarT}
as follows:
