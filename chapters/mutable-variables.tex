...
variables gives us a chance to explore a different design of function
application semantics. We will see what is call-by-reference semantics and how
it differs from call-by-value semantics.
...
Note that \lang lacks sequenced expressions, which exist in \bfae. Actually, it
is not problematic at all. We can desugar sequenced expressions into
...
We may use sequenced expressions in examples as they can be easily desugared.
...
values becuase expressions creating boxes evaluate to addresses. However, there
...
The evalution of the subexpressions is the same as \bfae. However, the remaining
