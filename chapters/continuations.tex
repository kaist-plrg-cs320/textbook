...
call \code{numOfWords} except one erroneous case, where both cache and file are
...
prefer using \code{return} like below:
...
The implementation without \code{return} would be like below:
