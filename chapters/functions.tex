...
has one integral parameter and returns an integer, i.e. its type is \code{Int =>
...
a function value are how it behave. While the parameters and body of a function
...
has elements obtained \textbf{map}ping a given function to the elements of a
given list to the elements of a given list.
