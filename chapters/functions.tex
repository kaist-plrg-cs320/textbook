...
This chapter focuses on use of functions in functional programming.
...
This chapter explains what first-class functions are.
...
Int}. Actually, there is no need to write
